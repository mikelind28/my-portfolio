    ...
    <AnimatePresence>
      {dropDownNavOpen && (
        <motion.div
          ...
          className="from-dark-violet4 to-dark-violet3 sticky top-20 hidden h-dvh w-50 bg-linear-to-b text-nowrap sm:block"
        >
          <nav>
            <ul className="flex flex-col gap-5 p-6 text-2xl text-pink-100 *:hover:text-pink-50 sm:text-xl">
