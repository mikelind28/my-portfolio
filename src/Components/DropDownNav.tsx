...
export default function DropDownNav({ setDropDownNavOpen }: DropDownNavType) {
  return (
    <div className="from-dark-violet4 via-dark-violet4 to-fuchsia-950 light:from-white light:from-40% light:via-orange-100 light:via-80% light:to-fuchsia-200 h-dvh w-dvw bg-linear-to-b sm:hidden">
      <IoClose
        onClick={() => setDropDownNavOpen(false)}
