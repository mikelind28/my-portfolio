...
export default function About() {
  return (
    <main className="w-full h-fit p-2 pt-0 flex flex-col gap-4">
      <H1 text={"About Me."} />

      <div className="flex flex-col gap-8 px-4 mb-8">
        <GlowingBackground glowClass="bg-radial from-fuchsia-800/60 from-40% to-fuchsia-900/50">
          <div className="m-8 w-full px-8 text-center">
            <AboutH2 text={"My Background"} />

            <p className="mx-4 text-base/5 text-orange-100/95 text-shadow-sm">
        ...
        <GlowingBackground glowClass='bg-radial from-orange-800/70 from-40% to-orange-900/50'>
          <div className="m-8 w-full px-8 text-center">
        ...
        <GlowingBackground glowClass="bg-radial from-green-800/70 from-40% to-green-900/50">
          <div className="m-8 px-8 text-center">
            ...
            <p className="mx-4 text-center text-base/5 text-orange-100/95 text-shadow-sm">
