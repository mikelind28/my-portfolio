      ...
      <div className="flex flex-col gap-4">
        <div className="light:my-0 mb- relative mt-2 flex h-fit w-full items-center justify-center overflow-visible rounded-xl p-4">
          ...
          <div className="mx-12 mt-2 mb-4 flex flex-col items-center gap-2 p-2 font-light">
            ...
            <p className="light:text-fuchsia-800 light:text-shadow-none text-center text-base/5 text-nowrap text-fuchsia-200 text-shadow-sm">
              <a href="mailto:mike@mike-lind-dev.com" className="font-mono">
        ...
        <div className="light:my-0 relative mt-2 mb-4 flex h-fit w-full items-center justify-center overflow-visible rounded-xl p-4">
          ...
          <div className="mx-12 mt-2 mb-4 flex flex-col items-center gap-2 p-2 font-light">
            <p className="light:text-fuchsia-700 light:text-shadow-none text-center text-lg/6 text-nowrap text-fuchsia-100 text-shadow-md/15">
